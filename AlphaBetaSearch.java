...
/**
 * imported from https://github.com/aimacode/aima-java/blob/AIMA3e/aima-core/src/main/java/aima/core/search/adversarial/AlphaBetaSearch.java
 * 
...
public class AlphaBetaSearch<S, A, P> implements
    ...
    public A makeDecision(S state) {
        ...
        List<A> actionList = game.getActions(state);
